...
OUTDIR = "/workspace/keytar/take3"
SHOTS = OUTDIR + "/shots"
os.makedirs(SHOTS, exist_ok=True)
TIMES_F = open(OUTDIR + "/shot_times.txt", "w")
    ...
    with sync_playwright() as p:
        ...
        def snap_until(abs_wall):
            ...
            while True:
                ...
                t_before = time.time(); page.screenshot(path=f"{SHOTS}/{k:05d}.jpg", type="jpeg", quality=82); TIMES_F.write(f"{k} {t_before} {time.time()}\n"); TIMES_F.flush()
                shot_n += 1
