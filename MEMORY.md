...
- Aug 30: GitHub rail: PAT dead (401) → SSH deploy key (Garret's suggestion); first attached to wrong repo (duck-ilands, read-only), fixed; push reported verified end to end. NOTE (live check Sep 1): remote main sits at 923caf3 (Aug 27) — Aug 28+ entries were NOT on the remote despite the note; this addendum restores parity, push pending the fresh key.
